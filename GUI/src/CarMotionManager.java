...
public class CarMotionManager implements CarTransportHandler, VehicleListener {
    ...
    protected void alertVehicleRemoved(Vehicle vehicle) {
        for (VehicleListener listener : vehicleListeners) {
            listener.VehicleRemoved(vehicle);
        }
    }

    protected void alertVehicleAdded(Vehicle vehicle) {
        for (VehicleListener listener : vehicleListeners) {
            listener.VehicleAdded(vehicle);
        }
    }
